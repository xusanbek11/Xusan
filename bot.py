...
# VIP foydalanuvchilar ID ro'yxati (Qo'lda qo'shish uchun: masalan vip_users = {123456789})
vip_users = set()
...
def start_handler(message):
    welcome_text = (
        ...
        "Akvarium va baliqlar parvarishi bo'yicha yordamchiman. Savollaringizni berishingiz mumkin."
    )
